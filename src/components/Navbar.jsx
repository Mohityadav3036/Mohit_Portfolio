      ...
      <div className="w-full flex justify-between items-center max-w-7xl max-auto">
        ...
        >
          ...
          <p className="text-white text-[25px] font-bold cursor-pointer flex items-center">
            Mohit<span className="sm:block hidden"> &nbsp; Yada</span>
          </p>
        </Link>
        ...
        {navLinks.map((Link) => (
          ...
          >
            {Link.title === "Download CV" ? (
              <a href={resume} download="mohit_resume">
                {Link.title}
              </a>
            ) : (
         ...
         />
         <div className={`${!toggle ? 'hidden' : 'flex'} p-6 black-gradient top-20 right-0 mx-4 absolute my-2 min-w-[140px] z-10 rounded-xl`}>
